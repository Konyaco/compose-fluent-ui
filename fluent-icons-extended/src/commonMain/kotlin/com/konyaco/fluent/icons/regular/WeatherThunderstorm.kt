...
public val Icons.Regular.WeatherThunderstorm: ImageVector
    get() {
        ...
        _weatherThunderstorm = fluentIcon(name = "Regular.WeatherThunderstorm") {
            fluentPath {
                ...
                lineToRelative(-1.12f, 1.24f)
                horizontalLineToRelative(2.28f)
                curveToRelative(0.6f, 0.0f, 0.94f, 0.65f, 0.65f, 1.13f)
                ...
                arcToRelative(1.33f, 1.33f, 0.0f, false, false, 0.0f, -1.5f)
