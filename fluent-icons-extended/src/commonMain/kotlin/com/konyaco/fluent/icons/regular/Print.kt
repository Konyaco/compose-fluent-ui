...
public val Icons.Regular.Print: ImageVector
    get() {
        if (_print != null) {
            return _print!!
        }
        _print = fluentIcon(name = "Regular.Print") {
            fluentPath {
                moveTo(15.75f, 3.0f)
                ...
                curveToRelative(0.4f, -0.01f, 0.73f, -0.34f, 0.73f, -0.75f)
                verticalLineToRelative(-6.0f)
                curveToRelative(0.0f, -0.96f, -0.8f, -1.75f, -1.76f, -1.75f)
                close()
                moveTo(15.75f, 4.5f)
                horizontalLineToRelative(-7.5f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, -0.75f, 0.75f)
