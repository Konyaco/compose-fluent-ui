...
public val Icons.Regular.ShoppingBagTag: ImageVector
    get() {
        if (_shoppingBagTag != null) {
            return _shoppingBagTag!!
        }
        _shoppingBagTag = fluentIcon(name = "Regular.ShoppingBagTag") {
            fluentPath {
                moveTo(7.0f, 7.0f)
                lineTo(7.0f, 5.0f)
                ...
                arcToRelative(3.0f, 3.0f, 0.0f, false, false, -0.53f, -0.41f)
                lineTo(18.5f, 8.5f)
