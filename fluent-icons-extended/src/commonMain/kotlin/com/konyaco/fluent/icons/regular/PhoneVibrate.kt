...
public val Icons.Regular.PhoneVibrate: ImageVector
    get() {
        if (_phoneVibrate != null) {
            return _phoneVibrate!!
        }
        _phoneVibrate = fluentIcon(name = "Regular.PhoneVibrate") {
            fluentPath {
                moveTo(15.75f, 2.0f)
                ...
                lineTo(20.7f, 8.23f)
                lineTo(21.28f, 9.68f)
                curveToRelative(0.33f, 0.83f, 0.24f, 1.77f, -0.25f, 2.51f)
                ...
                curveToRelative(0.24f, -0.31f, 0.31f, -0.7f, 0.21f, -1.08f)
                lineToRelative(-0.04f, -0.14f)
                lineToRelative(-0.59f, -1.45f)
