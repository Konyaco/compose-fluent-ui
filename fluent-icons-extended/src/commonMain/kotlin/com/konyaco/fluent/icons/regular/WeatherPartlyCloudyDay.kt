...
public val Icons.Regular.WeatherPartlyCloudyDay: ImageVector
    get() {
        if (_weatherPartlyCloudyDay != null) {
            return _weatherPartlyCloudyDay!!
        }
        _weatherPartlyCloudyDay = fluentIcon(name = "Regular.WeatherPartlyCloudyDay") {
            fluentPath {
                moveTo(13.0f, 8.0f)
                ...
                close()
                moveTo(13.0f, 9.5f)
                arcToRelative(3.86f, 3.86f, 0.0f, false, false, -3.87f, 3.9f)
                curveToRelative(0.0f, 0.35f, -0.32f, 0.63f, -0.69f, 0.63f)
                ...
                curveToRelative(1.26f, 0.0f, 2.29f, -1.0f, 2.29f, -2.23f)
                ...
                moveTo(10.85f, 7.33f)
                lineTo(10.68f, 7.39f)
                curveToRelative(-0.53f, 0.19f, -1.02f, 0.44f, -1.46f, 0.75f)
                arcToRelative(2.44f, 2.44f, 0.0f, false, false, -2.8f, 3.67f)
                curveToRelative(-0.48f, 0.14f, -0.94f, 0.36f, -1.36f, 0.64f)
