...
public val Icons.Regular.WeatherRainShowersDay: ImageVector
    get() {
        if (_weatherRainShowersDay != null) {
            return _weatherRainShowersDay!!
        }
        _weatherRainShowersDay = fluentIcon(name = "Regular.WeatherRainShowersDay") {
            fluentPath {
                moveTo(13.0f, 6.01f)
                ...
                close()
                moveTo(13.0f, 7.51f)
                arcToRelative(3.86f, 3.86f, 0.0f, false, false, -3.87f, 3.89f)
                ...
                curveToRelative(-0.53f, 0.19f, -1.02f, 0.44f, -1.46f, 0.76f)
                arcToRelative(2.44f, 2.44f, 0.0f, false, false, -2.8f, 3.67f)
                curveToRelative(-0.48f, 0.13f, -0.94f, 0.35f, -1.36f, 0.63f)
