...
public val Icons.Regular.StarDismiss: ImageVector
    get() {
        if (_starDismiss != null) {
            return _starDismiss!!
        }
        _starDismiss = fluentIcon(name = "Regular.StarDismiss") {
            fluentPath {
                moveTo(10.79f, 3.1f)
                ...
                arcToRelative(6.46f, 6.46f, 0.0f, false, false, -1.52f, -0.61f)
                lineToRelative(1.15f, -1.13f)
                lineToRelative(-5.05f, -0.74f)
                arcToRelative(1.35f, 1.35f, 0.0f, false, true, -1.01f, -0.73f)
                lineTo(12.0f, 4.04f)
                lineTo(9.74f, 8.62f)
                curveToRelative(-0.2f, 0.4f, -0.58f, 0.67f, -1.02f, 0.73f)
                lineToRelative(-5.05f, 0.74f)
                lineToRelative(3.66f, 3.56f)
                curveToRelative(0.32f, 0.31f, 0.46f, 0.76f, 0.39f, 1.2f)
                lineToRelative(-0.87f, 5.02f)
                lineTo(11.0f, 17.7f)
                curveToRelative(0.02f, 0.54f, 0.1f, 1.07f, 0.24f, 1.57f)
