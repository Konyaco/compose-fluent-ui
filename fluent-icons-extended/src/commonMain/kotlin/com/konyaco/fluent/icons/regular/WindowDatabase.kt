...
public val Icons.Regular.WindowDatabase: ImageVector
    get() {
        if (_windowDatabase != null) {
            return _windowDatabase!!
        }
        _windowDatabase = fluentIcon(name = "Regular.WindowDatabase") {
            fluentPath {
                moveTo(6.25f, 3.0f)
                ...
                curveToRelative(0.52f, 0.05f, 1.03f, 0.13f, 1.5f, 0.25f)
                lineTo(21.0f, 6.25f)
