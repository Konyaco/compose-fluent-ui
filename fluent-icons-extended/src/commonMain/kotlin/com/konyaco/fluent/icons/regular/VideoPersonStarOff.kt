...
public val Icons.Regular.VideoPersonStarOff: ImageVector
    get() {
        if (_videoPersonStarOff != null) {
            return _videoPersonStarOff!!
        }
        _videoPersonStarOff = fluentIcon(name = "Regular.VideoPersonStarOff") {
            fluentPath {
                moveTo(3.28f, 2.22f)
                ...
                curveToRelative(-0.2f, -0.47f, -0.34f, -0.97f, -0.42f, -1.5f)
                lineTo(8.5f, 18.5f)
                lineTo(8.5f, 15.7f)
                curveToRelative(0.03f, -0.1f, 0.13f, -0.19f, 0.25f, -0.19f)
                ...
                curveToRelative(0.0f, 0.1f, -0.01f, 0.2f, -0.03f, 0.29f)
                lineToRelative(1.16f, 1.16f)
