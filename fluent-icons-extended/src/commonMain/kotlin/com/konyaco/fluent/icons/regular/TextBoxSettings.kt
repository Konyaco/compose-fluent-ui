...
public val Icons.Regular.TextBoxSettings: ImageVector
    get() {
        if (_textBoxSettings != null) {
            return _textBoxSettings!!
        }
        _textBoxSettings = fluentIcon(name = "Regular.TextBoxSettings") {
            fluentPath {
                moveTo(18.25f, 3.0f)
                ...
                curveToRelative(-0.71f, 0.34f, -1.34f, 0.8f, -1.88f, 1.36f)
                lineTo(6.75f, 13.0f)
