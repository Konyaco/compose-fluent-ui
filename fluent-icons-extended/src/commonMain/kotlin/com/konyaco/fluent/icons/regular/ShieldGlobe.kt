...
public val Icons.Regular.ShieldGlobe: ImageVector
    get() {
        if (_shieldGlobe != null) {
            return _shieldGlobe!!
        }
        _shieldGlobe = fluentIcon(name = "Regular.ShieldGlobe") {
            fluentPath {
                moveTo(3.75f, 5.0f)
                ...
                curveToRelative(0.07f, 1.03f, 0.29f, 1.9f, 0.57f, 2.52f)
                close()
                moveTo(11.6f, 8.73f)
                curveToRelative(-0.28f, 0.62f, -0.5f, 1.49f, -0.57f, 2.52f)
                horizontalLineToRelative(1.94f)
                ...
                arcToRelative(9.63f, 9.63f, 0.0f, false, true, -0.55f, 2.76f)
                close()
