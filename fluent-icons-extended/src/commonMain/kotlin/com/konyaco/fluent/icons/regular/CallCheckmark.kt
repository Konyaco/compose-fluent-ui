    ...
    get() {
        ...
        _callCheckmark = fluentIcon(name = "Regular.CallCheckmark") {
            fluentPath {
                ...
                curveToRelative(2.22f, 3.83f, 4.68f, 6.16f, 7.44f, 6.93f)
                ...
                curveToRelative(0.52f, -0.16f, 1.07f, 0.03f, 1.38f, 0.47f)
                lineToRelative(1.28f, 1.77f)
                curveToRelative(0.37f, 0.5f, 0.3f, 1.2f, -0.15f, 1.64f)
