...
public val Icons.Regular.Trophy: ImageVector
    get() {
        if (_trophy != null) {
            return _trophy!!
        }
        _trophy = fluentIcon(name = "Regular.Trophy") {
            fluentPath {
                moveTo(15.25f, 2.0f)
                ...
                curveToRelative(-0.83f, 0.0f, -1.52f, 0.58f, -1.7f, 1.35f)
                lineToRelative(-0.03f, 0.15f)
                horizontalLineToRelative(8.47f)
                arcTo(1.75f, 1.75f, 0.0f, false, false, 14.4f, 19.0f)
