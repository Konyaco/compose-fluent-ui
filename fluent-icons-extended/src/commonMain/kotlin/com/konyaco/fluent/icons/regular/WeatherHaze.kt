...
public val Icons.Regular.WeatherHaze: ImageVector
    get() {
        if (_weatherHaze != null) {
            return _weatherHaze!!
        }
        _weatherHaze = fluentIcon(name = "Regular.WeatherHaze") {
            fluentPath {
                moveTo(6.84f, 13.98f)
                ...
                close()
                moveTo(8.11f, 10.95f)
                arcToRelative(5.64f, 5.64f, 0.0f, false, false, -1.55f, 0.08f)
                ...
                curveToRelative(1.0f, 0.16f, 2.02f, 0.65f, 3.31f, 1.4f)
                curveToRelative(2.83f, 1.65f, 6.06f, 1.4f, 8.07f, -0.03f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, -0.88f, -1.22f)
                curveToRelative(-0.4f, 0.3f, -0.9f, 0.52f, -1.44f, 0.68f)
                arcToRelative(5.9f, 5.9f, 0.0f, false, true, -1.65f, 0.22f)
                arcToRelative(6.72f, 6.72f, 0.0f, false, true, -3.34f, -0.94f)
                arcTo(11.44f, 11.44f, 0.0f, false, false, 8.55f, 11.0f)
                lineToRelative(-0.44f, -0.05f)
                close()
                moveTo(17.52f, 12.0f)
                verticalLineToRelative(0.2f)
                curveToRelative(-0.45f, 0.19f, -0.97f, 0.3f, -1.53f, 0.33f)
                arcTo(4.03f, 4.03f, 0.0f, false, false, 8.51f, 10.0f)
                arcToRelative(6.64f, 6.64f, 0.0f, false, false, -1.65f, -0.02f)
