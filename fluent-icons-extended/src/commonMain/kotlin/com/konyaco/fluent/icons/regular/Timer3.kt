...
public val Icons.Regular.Timer3: ImageVector
    get() {
        if (_timer3 != null) {
            return _timer3!!
        }
        _timer3 = fluentIcon(name = "Regular.Timer3") {
            fluentPath {
                moveTo(20.4f, 12.15f)
                arcToRelative(8.5f, 8.5f, 0.0f, true, false, -5.39f, 9.3f)
                arcToRelative(1.75f, 1.75f, 0.0f, false, true, 0.65f, -1.98f)
                arcToRelative(7.0f, 7.0f, 0.0f, true, true, 3.18f, -7.45f)
                arcToRelative(4.68f, 4.68f, 0.0f, false, true, 1.55f, 0.13f)
                close()
                moveTo(12.74f, 8.65f)
