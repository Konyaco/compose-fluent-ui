...
public val Icons.Regular.TextGrammarArrowRight: ImageVector
    get() {
        if (_textGrammarArrowRight != null) {
            return _textGrammarArrowRight!!
        }
        _textGrammarArrowRight = fluentIcon(name = "Regular.TextGrammarArrowRight") {
            fluentPath {
                moveTo(21.25f, 5.0f)
                lineTo(2.75f, 5.0f)
                ...
                arcToRelative(6.52f, 6.52f, 0.0f, false, false, -1.08f, -1.5f)
                horizontalLineToRelative(10.16f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, -0.1f, 1.5f)
                close()
                moveTo(21.25f, 17.0f)
                horizontalLineToRelative(-8.27f)
                arcToRelative(6.62f, 6.62f, 0.0f, false, true, -0.06f, 1.5f)
