    ...
    get() {
        ...
        _handRight = fluentIcon(name = "Regular.HandRight") {
            fluentPath {
                ...
                close()
                moveTo(13.99f, 3.25f)
                curveToRelative(-0.21f, 0.0f, -0.42f, 0.03f, -0.6f, 0.09f)
                close()
                moveTo(13.39f, 3.34f)
                ...
                curveToRelative(0.0f, 2.18f, 1.17f, 4.52f, 1.92f, 5.8f)
