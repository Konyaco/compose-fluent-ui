...
public val Icons.Regular.SparkleCircle: ImageVector
    get() {
        if (_sparkleCircle != null) {
            return _sparkleCircle!!
        }
        _sparkleCircle = fluentIcon(name = "Regular.SparkleCircle") {
            fluentPath {
                moveTo(12.0f, 3.5f)
                ...
                arcToRelative(0.99f, 0.99f, 0.0f, false, false, -1.9f, 0.0f)
                lineToRelative(-0.18f, 0.6f)
                arcToRelative(0.85f, 0.85f, 0.0f, false, true, -0.57f, 0.56f)
                lineToRelative(-0.6f, 0.18f)
                arcToRelative(0.99f, 0.99f, 0.0f, false, false, 0.0f, 1.9f)
                lineToRelative(0.6f, 0.18f)
                curveToRelative(0.28f, 0.08f, 0.49f, 0.3f, 0.57f, 0.57f)
                lineToRelative(0.18f, 0.6f)
                arcToRelative(0.99f, 0.99f, 0.0f, false, false, 1.9f, 0.0f)
                lineToRelative(0.18f, -0.6f)
                curveToRelative(0.08f, -0.27f, 0.3f, -0.49f, 0.57f, -0.57f)
                lineToRelative(0.6f, -0.18f)
                arcToRelative(0.99f, 0.99f, 0.0f, false, false, 0.0f, -1.9f)
                lineToRelative(-0.6f, -0.18f)
                arcToRelative(0.85f, 0.85f, 0.0f, false, true, -0.57f, -0.57f)
                lineToRelative(-0.18f, -0.6f)
                close()
            }
        }
