...
public val Icons.Regular.PlayCircleHint: ImageVector
    get() {
        if (_playCircleHint != null) {
            return _playCircleHint!!
        }
        _playCircleHint = fluentIcon(name = "Regular.PlayCircleHint") {
            fluentPath {
                moveTo(12.0f, 2.0f)
                ...
                close()
                moveTo(9.0f, 9.24f)
                curveToRelative(0.0f, -0.94f, 1.02f, -1.55f, 1.86f, -1.09f)
                lineToRelative(5.75f, 3.2f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, 0.0f, 1.3f)
                lineToRelative(-5.75f, 3.19f)
                arcTo(1.25f, 1.25f, 0.0f, false, true, 9.0f, 14.74f)
