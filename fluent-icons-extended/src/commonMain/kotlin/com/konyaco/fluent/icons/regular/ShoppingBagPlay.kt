...
public val Icons.Regular.ShoppingBagPlay: ImageVector
    get() {
        if (_shoppingBagPlay != null) {
            return _shoppingBagPlay!!
        }
        _shoppingBagPlay = fluentIcon(name = "Regular.ShoppingBagPlay") {
            fluentPath {
                moveTo(7.0f, 5.0f)
                ...
                lineTo(8.0f, 20.5f)
                arcTo(2.5f, 2.5f, 0.0f, false, true, 5.5f, 18.0f)
                lineTo(5.5f, 8.5f)
                lineTo(13.0f, 8.5f)
