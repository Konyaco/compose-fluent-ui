...
public val Icons.Regular.PhoneArrowRight: ImageVector
    get() {
        if (_phoneArrowRight != null) {
            return _phoneArrowRight!!
        }
        _phoneArrowRight = fluentIcon(name = "Regular.PhoneArrowRight") {
            fluentPath {
                moveTo(13.75f, 2.0f)
                ...
                curveToRelative(0.46f, 0.6f, 1.02f, 1.1f, 1.66f, 1.5f)
                lineTo(6.25f, 21.99f)
