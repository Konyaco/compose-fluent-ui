...
public val Icons.Regular.TabShieldDismiss: ImageVector
    get() {
        if (_tabShieldDismiss != null) {
            return _tabShieldDismiss!!
        }
        _tabShieldDismiss = fluentIcon(name = "Regular.TabShieldDismiss") {
            fluentPath {
                moveTo(3.0f, 5.75f)
                ...
                arcToRelative(5.0f, 5.0f, 0.0f, false, true, -1.5f, -0.9f)
                lineTo(19.5f, 5.75f)
                ...
                arcToRelative(6.67f, 6.67f, 0.0f, false, false, 1.2f, 1.5f)
                lineTo(5.74f, 21.0f)
