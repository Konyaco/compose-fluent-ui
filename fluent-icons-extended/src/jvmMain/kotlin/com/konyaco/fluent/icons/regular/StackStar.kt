...
public val Icons.Regular.StackStar: ImageVector
    get() {
        if (_stackStar != null) {
            return _stackStar!!
        }
        _stackStar = fluentIcon(name = "Regular.StackStar") {
            fluentPath {
                moveTo(9.5f, 5.85f)
                curveToRelative(0.28f, 0.0f, 0.54f, 0.16f, 0.67f, 0.41f)
                lineTo(11.0f, 7.91f)
                lineToRelative(1.6f, 0.2f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, 0.39f, 1.32f)
                lineToRelative(-1.15f, 0.95f)
                lineToRelative(0.4f, 1.8f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, -1.13f, 0.8f)
