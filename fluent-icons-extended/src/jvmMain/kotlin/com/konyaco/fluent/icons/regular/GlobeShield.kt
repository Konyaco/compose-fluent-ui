...
public val Icons.Regular.GlobeShield: ImageVector
    get() {
        ...
        _globeShield = fluentIcon(name = "Regular.GlobeShield") {
            fluentPath {
                moveTo(12.0f, 2.0f)
                arcToRelative(10.0f, 10.0f, 0.0f, false, true, 10.0f, 9.9f)
                arcToRelative(6.06f, 6.06f, 0.0f, false, true, -1.52f, -0.57f)
                curveToRelative(-0.04f, -0.46f, -0.11f, -0.9f, -0.22f, -1.33f)
                ...
                curveToRelative(-0.33f, 0.28f, -0.83f, 0.65f, -1.45f, 0.97f)
                ...
                curveToRelative(-0.52f, -0.82f, -0.95f, -1.84f, -1.27f, -3.01f)
                ...
                arcTo(8.53f, 8.53f, 0.0f, false, false, 4.25f, 8.5f)
                lineTo(7.3f, 8.5f)
