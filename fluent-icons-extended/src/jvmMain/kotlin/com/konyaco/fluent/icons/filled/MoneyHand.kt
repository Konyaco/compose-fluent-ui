    ...
    get() {
        ...
        _moneyHand = fluentIcon(name = "Filled.MoneyHand") {
            fluentPath {
                ...
                curveToRelative(0.32f, 0.26f, 0.7f, 0.44f, 1.13f, 0.53f)
                lineTo(14.5f, 19.0f)
                ...
                arcToRelative(2.49f, 2.49f, 0.0f, false, false, -0.97f, 1.32f)
                curveToRelative(-0.1f, 0.38f, -0.08f, 0.76f, 0.02f, 1.1f)
