    ...
    get() {
        ...
        _gif = fluentIcon(name = "Filled.Gif") {
            fluentPath {
                ...
                arcToRelative(0.63f, 0.63f, 0.0f, false, false, 0.54f, -1.13f)
                curveToRelative(-0.49f, -0.24f, -0.9f, -0.32f, -1.5f, -0.32f)
                close()
                moveTo(12.63f, 8.99f)
                ...
                lineTo(15.0f, 14.46f)
                curveToRelative(0.04f, 0.27f, 0.25f, 0.48f, 0.52f, 0.52f)
                lineToRelative(0.1f, 0.01f)
