...
public val Icons.Regular.Orientation: ImageVector
    get() {
        if (_orientation != null) {
            return _orientation!!
        }
        _orientation = fluentIcon(name = "Regular.Orientation") {
            fluentPath {
                moveTo(6.75f, 4.0f)
