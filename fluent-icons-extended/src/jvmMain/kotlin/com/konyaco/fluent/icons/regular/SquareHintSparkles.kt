...
public val Icons.Regular.SquareHintSparkles: ImageVector
    get() {
        if (_squareHintSparkles != null) {
            return _squareHintSparkles!!
        }
        _squareHintSparkles = fluentIcon(name = "Regular.SquareHintSparkles") {
            fluentPath {
                moveTo(16.09f, 6.41f)
                ...
                lineTo(12.0f, 4.5f)
                arcToRelative(1.6f, 1.6f, 0.0f, false, true, 0.28f, -0.93f)
                close()
                moveTo(3.75f, 10.0f)
