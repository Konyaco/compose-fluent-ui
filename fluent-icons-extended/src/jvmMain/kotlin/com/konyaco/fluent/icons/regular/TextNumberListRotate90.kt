...
public val Icons.Regular.TextNumberListRotate90: ImageVector
    get() {
        if (_textNumberListRotate90 != null) {
            return _textNumberListRotate90!!
        }
        _textNumberListRotate90 = fluentIcon(name = "Regular.TextNumberListRotate90") {
            fluentPath {
                moveTo(21.25f, 6.0f)
                ...
                close()
                moveTo(11.75f, 20.5f)
                curveToRelative(0.42f, 0.0f, 0.76f, -0.34f, 0.76f, -0.75f)
                verticalLineToRelative(-9.0f)
