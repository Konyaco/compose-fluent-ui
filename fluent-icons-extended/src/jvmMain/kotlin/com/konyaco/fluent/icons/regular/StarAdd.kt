...
public val Icons.Regular.StarAdd: ImageVector
    get() {
        if (_starAdd != null) {
            return _starAdd!!
        }
        _starAdd = fluentIcon(name = "Regular.StarAdd") {
            fluentPath {
                moveTo(10.79f, 3.1f)
                ...
                arcToRelative(6.46f, 6.46f, 0.0f, false, false, -1.52f, -0.62f)
                lineToRelative(1.15f, -1.12f)
