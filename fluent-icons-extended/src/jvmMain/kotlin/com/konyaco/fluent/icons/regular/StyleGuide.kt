    ...
    get() {
        ...
        _styleGuide = fluentIcon(name = "Regular.StyleGuide") {
            fluentPath {
                ...
                moveTo(14.42f, 4.23f)
                lineTo(8.15f, 5.9f)
                curveToRelative(-0.67f, 0.18f, -1.07f, 0.86f, -0.89f, 1.53f)
                lineToRelative(2.72f, 10.14f)
                curveToRelative(0.18f, 0.67f, 0.86f, 1.06f, 1.53f, 0.89f)
                lineToRelative(6.28f, -1.69f)
                curveToRelative(0.67f, -0.17f, 1.06f, -0.86f, 0.88f, -1.53f)
                lineTo(15.96f, 5.11f)
                arcToRelative(1.25f, 1.25f, 0.0f, false, false, -1.54f, -0.88f)
                close()
                moveTo(4.88f, 10.18f)
