...
public val Icons.Regular.Patch: ImageVector
    get() {
        if (_patch != null) {
            return _patch!!
        }
        _patch = fluentIcon(name = "Regular.Patch") {
            fluentPath {
                moveTo(12.0f, 12.75f)
                ...
                arcToRelative(1.75f, 1.75f, 0.0f, false, false, -2.47f, 0.0f)
                lineTo(4.3f, 6.77f)
                curveToRelative(-0.69f, 0.69f, -0.69f, 1.8f, 0.0f, 2.48f)
                lineToRelative(1.0f, 1.0f)
