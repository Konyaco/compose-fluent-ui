...
public val Icons.Regular.NetworkCheck: ImageVector
    get() {
        if (_networkCheck != null) {
            return _networkCheck!!
        }
        _networkCheck = fluentIcon(name = "Regular.NetworkCheck") {
            fluentPath {
                ...
                close()
                moveTo(13.85f, 12.8f)
                lineToRelative(-2.6f, 3.51f)
                lineToRelative(-0.03f, 0.06f)
                arcToRelative(0.57f, 0.57f, 0.0f, false, false, 0.22f, 0.78f)
                lineToRelative(0.07f, 0.03f)
                curveToRelative(0.26f, 0.1f, 0.55f, 0.0f, 0.7f, -0.24f)
                lineToRelative(0.04f, -0.08f)
                lineToRelative(1.6f, -4.06f)
                close()
                moveTo(12.1f, 10.87f)
                lineToRelative(-1.23f, 1.66f)
                ...
                arcToRelative(7.65f, 7.65f, 0.0f, false, true, 1.8f, 3.15f)
                ...
                arcToRelative(0.75f, 0.75f, 0.0f, true, true, -1.4f, 0.55f)
