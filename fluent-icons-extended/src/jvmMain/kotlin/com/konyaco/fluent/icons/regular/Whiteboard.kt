...
public val Icons.Regular.Whiteboard: ImageVector
    get() {
        if (_whiteboard != null) {
            return _whiteboard!!
        }
        _whiteboard = fluentIcon(name = "Regular.Whiteboard") {
            fluentPath {
                ...
                lineToRelative(2.61f, -1.64f)
                curveToRelative(1.0f, -0.63f, 2.32f, -0.37f, 3.0f, 0.57f)
                lineToRelative(0.1f, 0.14f)
                curveToRelative(0.4f, 0.63f, 0.46f, 1.4f, 0.17f, 2.08f)
                lineToRelative(-0.08f, 0.17f)
                lineToRelative(-1.21f, 2.28f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, 0.93f, 1.05f)
                lineToRelative(0.1f, -0.04f)
                lineToRelative(1.76f, -1.0f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, 0.83f, 1.25f)
                lineToRelative(-0.09f, 0.06f)
                lineToRelative(-1.76f, 1.0f)
                arcToRelative(2.25f, 2.25f, 0.0f, false, true, -3.17f, -2.87f)
                lineToRelative(0.07f, -0.15f)
                lineToRelative(1.21f, -2.28f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, -0.96f, -1.04f)
                lineToRelative(-0.1f, 0.05f)
                lineToRelative(-3.41f, 2.14f)
                verticalLineToRelative(5.5f)
                curveToRelative(0.0f, 0.96f, 0.78f, 1.74f, 1.75f, 1.74f)
                ...
                lineToRelative(1.42f, -0.43f)
                curveToRelative(0.12f, -0.03f, 0.23f, -0.1f, 0.31f, -0.18f)
                lineToRelative(4.28f, -4.28f)
                lineToRelative(0.08f, -0.08f)
                arcToRelative(0.77f, 0.77f, 0.0f, false, false, -1.16f, -1.0f)
                close()
            }
        }
        return _whiteboard!!
