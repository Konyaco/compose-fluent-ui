    ...
    get() {
        ...
        _signature = fluentIcon(name = "Filled.Signature") {
            fluentPath {
                ...
                curveToRelative(0.25f, 0.1f, 0.43f, 0.09f, 0.7f, -0.05f)
                lineToRelative(0.15f, -0.08f)
                arcToRelative(5.0f, 5.0f, 0.0f, false, false, 0.17f, -0.11f)
                lineToRelative(0.66f, -0.46f)
                curveToRelative(0.62f, -0.4f, 1.17f, -0.67f, 1.85f, -0.84f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, 0.36f, 1.46f)
                curveToRelative(-0.4f, 0.1f, -0.76f, 0.25f, -1.14f, 0.49f)
                lineToRelative(-0.3f, 0.19f)
                lineToRelative(-0.48f, 0.33f)
                curveToRelative(-0.23f, 0.15f, -0.4f, 0.26f, -0.59f, 0.35f)
                arcToRelative(2.2f, 2.2f, 0.0f, false, true, -1.96f, 0.1f)
                curveToRelative(-0.74f, -0.3f, -1.04f, -0.78f, -1.32f, -1.72f)
                ...
                curveToRelative(0.44f, 0.04f, 0.92f, 0.07f, 1.42f, 0.07f)
                curveToRelative(1.18f, 0.0f, 2.03f, -0.42f, 3.08f, -1.37f)
                lineToRelative(0.26f, -0.24f)
                lineToRelative(0.53f, -0.5f)
                curveToRelative(0.24f, -0.23f, 0.42f, -0.4f, 0.6f, -0.55f)
                ...
                lineTo(9.06f, 18.0f)
                curveToRelative(-0.28f, 0.28f, -0.62f, 0.48f, -1.0f, 0.58f)
