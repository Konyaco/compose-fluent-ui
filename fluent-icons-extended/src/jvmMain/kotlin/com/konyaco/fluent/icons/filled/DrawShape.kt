    ...
    get() {
        ...
        _drawShape = fluentIcon(name = "Filled.DrawShape") {
            fluentPath {
                ...
                curveToRelative(-0.38f, -0.25f, -0.49f, -0.68f, -0.49f, -1.0f)
                lineTo(3.0f, 6.25f)
                close()
                moveTo(19.1f, 12.67f)
                lineToRelative(-5.9f, 5.9f)
                ...
                curveToRelative(-0.59f, 0.42f, -1.12f, 0.8f, -1.5f, 0.87f)
                curveToRelative(-0.52f, 0.12f, -1.16f, -0.12f, -1.62f, -0.38f)
                curveToRelative(-0.21f, -0.1f, -0.5f, 0.08f, -0.4f, 0.3f)
                curveToRelative(0.25f, 0.52f, 0.74f, 1.12f, 1.72f, 1.25f)
                curveToRelative(0.98f, 0.12f, 1.76f, -0.35f, 2.55f, -0.82f)
                curveToRelative(0.58f, -0.35f, 1.16f, -0.7f, 1.82f, -0.8f)
                curveToRelative(0.09f, -0.01f, 0.15f, 0.1f, 0.1f, 0.17f)
                curveToRelative(-0.23f, 0.48f, -0.35f, 1.37f, 0.23f, 1.82f)
                curveToRelative(0.84f, 0.66f, 3.23f, 0.29f, 3.82f, 0.09f)
