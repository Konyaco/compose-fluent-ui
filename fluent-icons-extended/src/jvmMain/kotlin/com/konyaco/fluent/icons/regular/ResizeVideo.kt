...
public val Icons.Regular.ResizeVideo: ImageVector
    get() {
        if (_resizeVideo != null) {
            return _resizeVideo!!
        }
        _resizeVideo = fluentIcon(name = "Regular.ResizeVideo") {
            fluentPath {
                moveTo(21.25f, 13.0f)
                ...
                verticalLineToRelative(-6.5f)
                curveTo(2.0f, 10.45f, 3.45f, 9.0f, 5.25f, 9.0f)
                horizontalLineToRelative(6.5f)
                close()
                moveTo(11.75f, 10.5f)
                horizontalLineToRelative(-6.5f)
                ...
                close()
                moveTo(6.06f, 13.1f)
                arcToRelative(0.5f, 0.5f, 0.0f, false, true, 0.6f, -0.23f)
                lineToRelative(0.08f, 0.03f)
                lineToRelative(3.96f, 2.16f)
                arcToRelative(0.5f, 0.5f, 0.0f, false, true, 0.07f, 0.83f)
                lineToRelative(-0.07f, 0.05f)
                lineToRelative(-3.96f, 2.16f)
                arcToRelative(0.5f, 0.5f, 0.0f, false, true, -0.73f, -0.35f)
                lineToRelative(-0.01f, -0.1f)
                verticalLineToRelative(-4.3f)
                arcToRelative(0.5f, 0.5f, 0.0f, false, true, 0.06f, -0.25f)
                close()
                moveTo(18.75f, 2.0f)
