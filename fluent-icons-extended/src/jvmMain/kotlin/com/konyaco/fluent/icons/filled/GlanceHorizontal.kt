    ...
    get() {
        ...
        _glanceHorizontal = fluentIcon(name = "Filled.GlanceHorizontal") {
            fluentPath {
                ...
                curveTo(3.8f, 3.0f, 3.0f, 3.8f, 3.0f, 4.75f)
                verticalLineToRelative(4.5f)
                curveTo(3.0f, 10.22f, 3.8f, 11.0f, 4.75f, 11.0f)
                horizontalLineToRelative(6.5f)
                ...
                curveTo(3.0f, 20.22f, 3.8f, 21.0f, 4.75f, 21.0f)
                ...
                curveToRelative(0.0f, 0.97f, 0.78f, 1.75f, 1.74f, 1.75f)
                horizontalLineToRelative(6.5f)
                curveToRelative(0.97f, 0.0f, 1.75f, -0.78f, 1.75f, -1.75f)
                verticalLineToRelative(-4.5f)
                close()
