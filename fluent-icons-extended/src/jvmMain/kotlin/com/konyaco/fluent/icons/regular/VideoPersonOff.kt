...
public val Icons.Regular.VideoPersonOff: ImageVector
    get() {
        if (_videoPersonOff != null) {
            return _videoPersonOff!!
        }
        _videoPersonOff = fluentIcon(name = "Regular.VideoPersonOff") {
            fluentPath {
                moveTo(2.22f, 2.22f)
                ...
                lineToRelative(-1.16f, -1.16f)
                arcToRelative(1.5f, 1.5f, 0.0f, false, false, -1.76f, -1.76f)
                close()
                moveTo(20.5f, 17.31f)
                lineTo(20.5f, 6.25f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, -0.75f, -0.75f)
