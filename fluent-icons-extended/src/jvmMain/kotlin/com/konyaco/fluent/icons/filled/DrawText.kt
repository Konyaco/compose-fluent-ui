    ...
    get() {
        ...
        _drawText = fluentIcon(name = "Filled.DrawText") {
            fluentPath {
                ...
                lineToRelative(0.33f, 0.93f)
                lineToRelative(1.57f, -1.57f)
                lineToRelative(-3.76f, -10.75f)
                ...
                curveToRelative(-0.58f, -0.44f, -0.46f, -1.33f, -0.22f, -1.81f)
                ...
                curveToRelative(-0.1f, -0.21f, 0.18f, -0.4f, 0.39f, -0.29f)
                curveToRelative(0.46f, 0.26f, 1.1f, 0.5f, 1.63f, 0.38f)
