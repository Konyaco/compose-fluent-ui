...
public val Icons.Regular.ShiftsDay: ImageVector
    get() {
        if (_shiftsDay != null) {
            return _shiftsDay!!
        }
        _shiftsDay = fluentIcon(name = "Regular.ShiftsDay") {
            fluentPath {
                moveTo(17.75f, 3.0f)
                ...
                curveToRelative(-0.24f, 0.25f, -0.53f, 0.47f, -0.79f, 0.67f)
                lineToRelative(-0.04f, 0.03f)
                arcToRelative(7.8f, 7.8f, 0.0f, false, false, -0.75f, 0.63f)
