...
public val Icons.Regular.Sparkle: ImageVector
    get() {
        if (_sparkle != null) {
            return _sparkle!!
        }
        _sparkle = fluentIcon(name = "Regular.Sparkle") {
            fluentPath {
                moveTo(8.66f, 15.73f)
                ...
                close()
                moveTo(8.29f, 11.48f)
                arcTo(4.4f, 4.4f, 0.0f, false, false, 6.21f, 10.0f)
                lineToRelative(-1.6f, -0.5f)
                lineToRelative(1.61f, -0.52f)
                arcTo(4.4f, 4.4f, 0.0f, false, false, 8.95f, 6.2f)
                lineToRelative(0.52f, -1.58f)
                lineToRelative(0.51f, 1.59f)
                arcToRelative(4.37f, 4.37f, 0.0f, false, false, 2.78f, 2.77f)
                lineToRelative(1.62f, 0.52f)
                lineToRelative(-1.59f, 0.52f)
                arcToRelative(4.38f, 4.38f, 0.0f, false, false, -2.77f, 2.77f)
                lineToRelative(-0.51f, 1.59f)
                lineToRelative(-0.52f, -1.59f)
                curveToRelative(-0.16f, -0.47f, -0.4f, -0.91f, -0.7f, -1.3f)
                close()
                ...
                close()
                moveTo(15.3f, 17.0f)
                arcToRelative(2.79f, 2.79f, 0.0f, false, true, 1.7f, 1.7f)
                arcToRelative(2.8f, 2.8f, 0.0f, false, true, 1.7f, -1.7f)
                arcToRelative(2.81f, 2.81f, 0.0f, false, true, -1.72f, -1.7f)
                arcTo(2.8f, 2.8f, 0.0f, false, true, 15.3f, 17.0f)
                close()
            }
        }
        return _sparkle!!
